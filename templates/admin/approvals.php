...
<div class="fsec" style="margin-bottom:14px;background:linear-gradient(135deg,#111827,#2563eb);color:#fff;border:0">
  <div style="font-weight:900;font-size:20px">Quality gate for publishing</div>
