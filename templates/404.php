...
<div style="margin-top:var(--hh);min-height:calc(100vh - var(--hh));display:flex;align-items:center;justify-content:center;padding:36px 18px">
  <div style="text-align:center;max-width:420px">
    ...
    <div style="font-family:'Fraunces',serif;font-size:22px;font-weight:700;margin-bottom:8px">Page Not Found</div>
    ...
    <div style="display:flex;gap:10px;justify-content:center;flex-wrap:wrap">
      ...
      <a href="/#prod-sec" class="btn btn-outline">Browse Products</a>
    </div>
  </div>
</div>
