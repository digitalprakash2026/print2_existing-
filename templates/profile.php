...
<div class="profile-page" style="background:var(--bg);padding:32px 0 80px">
  <div class="container" style="max-width:760px">
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap">
      <button class="btn btn-blue" style="padding:14px;border-radius:12px" onclick="saveProfile()">💾 Save Profile</button>
      <a href="/profile/security" class="btn btn-outline" style="padding:14px;border-radius:12px">🔐 Password Settings</a>
    </div>
  </div>
</div>
